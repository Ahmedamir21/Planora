        ...
        <div className="mt-5 space-y-5">
          <div>
            ...
            <p className="mt-1.5 text-[13px] leading-relaxed" style={{ color: 'var(--muted)' }}>
              Planora is a student-built, unofficial planner that helps students build and organize their {TERM_LABEL} course schedules. Pick a
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t pt-4" style={{ borderColor: 'var(--line-soft)' }}>
            <div>
              ...
              <p className="mt-1 text-[13px]" style={{ color: 'var(--muted)' }}>
                Version {SEMESTER_CONFIG.version} — Planora includes Best Schedule, live credits, instructor filters, sharing, calendar export, PWA install/offline support and AI-assisted planning. Built with React, TypeScript, Vite and Tailwind CSS.
              </p>
              <p className="mt-1 text-[13px]" style={{ color: 'var(--muted)' }}>
                {CREATOR_CREDIT}
              </p>
