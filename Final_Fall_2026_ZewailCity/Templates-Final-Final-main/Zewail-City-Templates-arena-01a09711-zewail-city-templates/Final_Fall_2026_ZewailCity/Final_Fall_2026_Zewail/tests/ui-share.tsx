...
const dom = new JSDOM('<!doctype html><html><body><div id="root"></div></body></html>', {
  url: 'https://zc-planora.vercel.app/?sbx_debug=1&schedule=STALE#about',
});
...
if (linkInput) {
  ...
  check('URL uses the live deployment origin — NOT a sandbox host', url.startsWith('https://zc-planora.vercel.app/?schedule='));
